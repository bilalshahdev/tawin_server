...
export const getCart = asyncHandler(async (req: Request, res: Response) => {
    ...
    res.status(STATUS_CODE.OK).json(new ApiResponse(req.t("cart.cart_retrieved"), cart));
});
...
export const clearCart = asyncHandler(async (req: Request, res: Response) => {
    ...
    res.status(STATUS_CODE.OK).json(new ApiResponse(req.t("cart.cart_cleared"), cart));
});
